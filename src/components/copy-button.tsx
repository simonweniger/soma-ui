...
export function CommandAddBlockButton({
  ...
  const commandMap: { [key: string]: string } = {
    pnpm: `pnpm dlx shadcn add https://somaui.dev/${style}/${block}`,
    npm: `npx shadcn add https://somaui.dev/${style}/${block}`,
    yarn: `npx shadcn add https://somaui.dev/${style}/${block}`,
    bun: `bunx --bun shadcn@latest add https://somaui.dev/${style}/${block}`,
  }
