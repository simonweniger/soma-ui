...
interface SomaDateFieldProps<T extends AriaDateValue>
...
function SomaDateField<T extends AriaDateValue>({
  label,
  description,
  className,
  errorMessage,
  ...props
}: SomaDateFieldProps<T>) {
  return (
    <DateField
      className={composeRenderProps(className, (className) =>
...
interface SomaTimeFieldProps<T extends AriaTimeValue>
...
function SomaTimeField<T extends AriaTimeValue>({
  label,
  description,
  errorMessage,
  className,
  ...props
}: SomaTimeFieldProps<T>) {
  return (
    <TimeField
      className={composeRenderProps(className, (className) =>
        cn("group flex flex-col gap-2", className)
...
export type { DateInputProps, SomaDateFieldProps, SomaTimeFieldProps }
