...
interface SomaCheckboxGroupProps extends AriaCheckboxGroupProps {
  label?: string
  description?: string
  errorMessage?: string | ((validation: AriaValidationResult) => string)
}

function SomaCheckboxGroup({
  label,
  description,
  errorMessage,
  className,
...
export { Checkbox, CheckboxGroup, SomaCheckboxGroup }
export type { SomaCheckboxGroupProps }
