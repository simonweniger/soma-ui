...
interface SomaDatePickerProps<T extends AriaDateValue>
...
function SomaDatePicker<T extends AriaDateValue>({
  label,
  description,
  errorMessage,
  className,
  ...props
}: SomaDatePickerProps<T>) {
  return (
    <DatePicker
...
interface SomaDateRangePickerProps<T extends AriaDateValue>
...
function SomaDateRangePicker<T extends AriaDateValue>({
  label,
  description,
  errorMessage,
  className,
  ...props
}: SomaDateRangePickerProps<T>) {
  return (
    <DateRangePicker
      className={composeRenderProps(className, (className) =>
        cn("group flex flex-col gap-2", className)
...
export type { SomaDatePickerProps, SomaDateRangePickerProps }
