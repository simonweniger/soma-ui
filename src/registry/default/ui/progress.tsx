...
interface SomaProgressBarProps extends ProgressProps {
  label?: string
  showValue?: boolean
}

function SomaProgressBar({
  label,
  className,
  showValue = true,
  ...props
}: SomaProgressBarProps) {
  return (
    <Progress
      className={composeRenderProps(className, (className) =>
...
export { Progress, SomaProgressBar }
export type { ProgressProps, SomaProgressBarProps }
