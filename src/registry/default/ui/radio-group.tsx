    ...
    >
      {composeRenderProps(children, (children, renderProps) => (
        <>
          <span
            className={cn(
              "soma-Radio flex aspect-square size-4 items-center justify-center rounded-full border border-primary text-primary ring-offset-background",
              /* Focus */
...
interface SomaRadioGroupProps extends AriaRadioGroupProps {
  label?: string
  description?: string
  errorMessage?: string | ((validation: AriaValidationResult) => string)
}

function SomaRadioGroup({
  label,
  description,
  className,
  errorMessage,
...
export { RadioGroup, Radio, SomaRadioGroup }
export type { SomaRadioGroupProps }
