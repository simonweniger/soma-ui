  ...
  return (
    <AriaGridList
      ...
      className={composeRenderProps(props.className, (className) =>
        cn(
          "soma-GridList group flex flex-col gap-2 overflow-auto rounded-md border bg-popover p-1 text-popover-foreground shadow-md outline-none",
          /* Empty */
  ...
  return (
    <AriaGridListItem
      ...
      className={composeRenderProps(className, (className) =>
        cn(
          "soma-GridListItem relative flex w-full cursor-default select-none items-center gap-3 rounded-sm px-2 py-1.5 text-sm outline-none",
          /* Disabled */
