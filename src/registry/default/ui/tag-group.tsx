...
function SomaTagGroup<T extends object>({
  label,
  description,
  className,
  errorMessage,
...
export { TagGroup, TagList, Tag, badgeVariants, SomaTagGroup }
export type { SomaTagGroupProps }
