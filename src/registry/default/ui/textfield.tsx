...
interface SomaTextFieldProps extends AriaTextFieldProps {
  label?: string
  description?: string
...
export { Input, TextField, SomaTextField, TextArea }
export type { SomaTextFieldProps }
