...
interface SomaCalendarProps<T extends AriaDateValue>
  extends AriaCalendarProps<T> {
  errorMessage?: string
}

function SomaCalendar<T extends AriaDateValue>({
  errorMessage,
  className,
  ...props
}: SomaCalendarProps<T>) {
...
interface SomaRangeCalendarProps<T extends AriaDateValue>
  extends AriaRangeCalendarProps<T> {
  errorMessage?: string
}

function SomaRangeCalendar<T extends AriaDateValue>({
  errorMessage,
  className,
  ...props
}: SomaRangeCalendarProps<T>) {
  return (
    <RangeCalendar
      className={composeRenderProps(className, (className) =>
        cn("w-fit", className)
...
export type { SomaCalendarProps, SomaRangeCalendarProps }
