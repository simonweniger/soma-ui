...
I have renamed the project from shadcn-aria to SomaUI. It will keep the same goal of mimicking shadcn/ui components and converting them to react aria components.
