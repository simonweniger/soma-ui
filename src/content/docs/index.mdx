...
SomaUI aims to take the components offered by [shadcn-ui](https://ui.shadcn.com/), and translate them to use [react-aria-components](https://react-spectrum.adobe.com/react-aria/react-aria-components.html) where possible.
...
[shadcn-ui](https://ui.shadcn.com/) offers beautifully designed components that you can copy and paste into your apps. Many of the components use radix for functionality. These are the main focus for SomaUI to convert.
