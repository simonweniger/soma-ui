...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/checkbox
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/checkbox
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/checkbox
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaCheckboxGroup`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="checkbox-group-reusable" />

The `SomaCheckboxGroup` component extends the props of React Aria CheckboxGroup and adds:
