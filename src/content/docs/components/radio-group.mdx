...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/radio-group
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/radio-group
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/radio-group
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaRadioGroup`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="radio-group-reusable" />

The `SomaRadioGroup` component extends the props of React Aria RadioGroup and adds:
