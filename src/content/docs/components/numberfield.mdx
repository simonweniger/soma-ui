...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/numberfield
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/numberfield
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/numberfield
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaNumberField`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="numberfield-reusable" />

The `SomaNumberField` component extends the props of React Aria NumberField and adds:
