...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/grid-list
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/grid-list
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/grid-list
    ```
  </PackageManagerContent>
...
.soma-GridList {
  ...
  @supports selector(:has(.foo)) {
    ...
    .soma-GridListItem[data-selected]:has(+ [data-selected]),
    .soma-GridListItem[data-selected]:has(
    ...
    .soma-GridListItem[data-selected] + [data-selected],
    .soma-GridListItem[data-selected]
