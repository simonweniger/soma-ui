...
The installed file includes a reusable wrapper `SomaTimeField`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="timefield-reusable" />

The `SomaTimeField` component extends the props of React Aria TimeField and adds:
