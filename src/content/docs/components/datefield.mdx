...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/datefield
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/datefield
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/datefield
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaDateField`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="datefield-reusable" />

The `SomaDateField` component extends the props of React Aria DateField and adds:
