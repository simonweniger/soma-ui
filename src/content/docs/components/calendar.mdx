...
The installed file includes a reusable wrapper `SomaCalendar`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="calendar-reusable" />

The `SomaCalendar` components extends the props of React Aria Calendar and adds:
