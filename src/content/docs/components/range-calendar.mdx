...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/calendar
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/calendar
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/calendar
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaRangeCalendar`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="rangecalendar-reusable" />

The `SomaRangeCalendar` component extends the props of React Aria RangeCalendar and adds:
