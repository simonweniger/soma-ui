...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/textfield
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/textfield
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/textfield
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaTextField`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="textfield-reusable" />

The `SomaTextField` component extends the props of React Aria TextField and adds:
