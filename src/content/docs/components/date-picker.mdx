...
The installed file includes a reusable wrapper `SomaDatePicker`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="datepicker-reusable" />

The `SomaDatePicker` component extends the props of React Aria DatePicker and adds:
