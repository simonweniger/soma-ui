...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/tag-group
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/tag-group
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/tag-group
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaTagGroup`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="tag-group-reusable" />

The `SomaTagGroup` component extends the props of React Aria TagGroup and TagList, and adds:
