...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/searchfield
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/searchfield
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/searchfield
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaSearchField`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="searchfield-reusable" />

The `SomaSearchField` component extends the props of React Aria SearchField and adds:
