...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/combobox
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/combobox
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/combobox
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaComboBox`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="combobox-reusable" />

The `SomaComboBox` component extends the props of React Aria ComboBox and adds:
