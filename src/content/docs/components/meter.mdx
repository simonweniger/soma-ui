...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/meter
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/meter
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/meter
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaMeter`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="meter-reusable" />

The `SomaMeter` component extends the props of React Aria Meter and adds:
