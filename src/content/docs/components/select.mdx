...
<PackageManagerTabs>
  <PackageManagerContent value="npm">
    ```bash
    npx shadcn@latest add https://somaui.dev/[[STYLE]]/select
    ```
  </PackageManagerContent>
  <PackageManagerContent value="pnpm">
    ```bash
    pnpm dlx shadcn@latest add https://somaui.dev/[[STYLE]]/select
    ```

  </PackageManagerContent>
  <PackageManagerContent value="bun">
    ```bash
    bunx --bun shadcn@latest add https://somaui.dev/[[STYLE]]/select
    ```
  </PackageManagerContent>
...
The installed file includes a reusable wrapper `SomaSelect`. This wrapper serves as an excellent starting point for use throughout your codebase.

<ComponentPreview name="select-reusable" />

The `SomaSelect` component extends the props of React Aria Select and adds:
